...
document.getElementById("calcForm").addEventListener("submit", function (event) {
  ...
  ca + 0.5 * a >= Math.round(3 + 1.5 * (cr + 0.5 * r)) ? document.getElementById("ratio").style.setProperty("color", "rgb(15, 224, 15)") : document.getElementById("ratio").style.setProperty("color", "red");
});